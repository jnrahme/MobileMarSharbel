...
object StoryCatalog {
    val saintCharbel = SaintStoryBook(
        id = "saint-charbel",
    ...
    val all: List<SaintStoryBook> = listOf(saintCharbel)
    ...
    private fun page(
        ...
        prayer = prayer,
        heart = heart,
        imageUrl = "https://marsharbel.com/media/storybook/images/$illustration",
        audioTrack = AudioTrack(
            url = "https://marsharbel.com/media/storybook/en-elevenlabs/page-${number.toString().padStart(2, '0')}.mp3",
